...
if(empty($_POST['regno'])){
    $error1 = "Register number field required";
}
...
if($row = mysqli_fetch_array($res)){
    if($row['val']==1){
        ...
        $error3 = 'email and regno incorrect!';
    }
}
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="forgotpwd.php">
                      ...
                      <div class="input-group">
                          ...
                          <input id="Register Number" name="regno"  value = "<?php if(isset($error2)){echo $_POST['regno'];}?>" placeholder="Register Number" class="form-control"  type="Register Number">
                        </div>
                      </div>
                        <div class="input-group">
